...
def get_dataloader(dataset, train_batch_size, test_batch_size, num_workers=2, collation_fct = None, root='../data'):
    ...
    trainloader = torch.utils.data.DataLoader(trainset, batch_size=train_batch_size, shuffle=True,
                                              num_workers = num_workers, collate_fn = collation_fct)
